...
export default function A4SheetPreview({ 
  ...
  return (
    <div className="a4-preview-workspace">
      ...
      <div className="top-action-row" style={{ display: "flex", justifyContent: "flex-end", gap: "12px", width: "100%", marginBottom: 0 }}>
        <button
      ...
      <div className="controls-panel arrangement-controls-panel" style={{ marginTop: 0 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          ...
          >
            <h3 style={{ fontSize: "16px", fontWeight: 700, color: "#facc15", margin: 0, display: "flex", alignItems: "center", gap: "8px" }}>
              <span className="new-sparkle-badge" style={{
                background: "#eab308",
                color: "#000000",
                fontSize: "10px",
                fontWeight: "900",
      ...
      <div className="controls-panel copies-planner-panel" style={{ marginTop: 0 }}>
        ...
        <h3 style={{ fontSize: "16px", fontWeight: 700, marginTop: "12px", color: "white" }}>
          Edit Copies Count
        </h3>
      </div>
